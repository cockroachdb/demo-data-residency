    ...
    <div className='flex flex-col gap-24 sm:gap-48 mx-auto max-w-6xl'>
      <section className='flex flex-col gap-8 justify-items-center'>
        ...
        <div className='flex flex-col gap-4'>
          <h1 className='m-0 text-brand-white text-3xl md:text-6xl text-center normal-case font-sans md:leading-tight'>
            The Art of Data Residency and Application Architecture.
          </h1>
          <h2 className='m-0 text-brand-white text-2xl text-center normal-case tracking-normal font-sans'>
      ...
      <section className='grid md:grid-cols-2 gap-16 items-center mx-auto max-w-4xl'>
        <div className='flex flex-col gap-8'>
          ...
          <p className='m-0 text-center md:text-left'>
            Certain images, colors, and shapes in the demo are restricted to the <b>United States</b> and will never be
            available outside of it. If you're located anywhere in the world except <b>Europe</b>, you will only be able
            to see <b>United States</b> data in the gallery. The data is replicated between CockroachDB instances on the
            East coast and West coast to provide high-availability and guard against regional outages
          </p>
          <TryDemoLink />
        </div>
