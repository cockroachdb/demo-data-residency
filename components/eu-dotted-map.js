...
import partEuJson from '../public/images/part-eu-json.png'
  ...
  return (
    <div className='overflow-hidden absolute mx-auto w-11/12 sm:w-full max-w-lg shadow-3xl border-2 border-depth-2 z-10'>
      ...
      >
        ...
        <g>
          <circle cx='274' cy='65' r='4' className='fill-brand-yellow' />
          <circle
            cx='274'
            cy='65'
            r='6'
            className='fill-brand-yellow motion-safe:animate-ping '
            style={{
